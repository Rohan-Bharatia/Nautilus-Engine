...
Read [CODE-OF-CONDUCT.md](https://github.com/Rohan-Bharatia/Nautilus-Engine/blob/main/.github/CODE-OF-CONDUCT.md) for information on our code of conduct.
...
[Submit a bug](https://github.com/Rohan-Bharatia/Nautilus-Engine/issues/new)
...
- Follow the coding style of the project (look at [Style
  Guide](https://github.com/Rohan-Bharatia/Nautilus/blob/main/.github/CONTRIBUTING.md#style-guide) for more info).
...
[Submit a pull request](https://github.com/Rohan-Bharatia/Nautilus-Engine/compare)
...
Read [STYLE-GUIDE.md](https://github.com/Rohan-Bharatia/Nautilus/blob/main/docs/style-guide.md) for information on using a consistent coding style.

## 📝 Licensing

Nautilus Engine is released under the [MIT License](https://opensource.org/licenses/MIT).
By contributing to Nautilus, all of your contributions will be licensed under and you agree to all the terms of a [MIT License](https://opensource.org/licenses/MIT).
